...
const features = [
  ...
  { id: 'sprints', eyebrow: 'Coming soon', title: 'Micro-Learning Sprints', description: 'Short, focused practices that turn a Koru insight into something you can try this week.', action: 'Coming soon', href: '#sprints', status: 'Coming soon', tone: 'muted' },
  { id: 'circles', eyebrow: 'Coming soon', title: 'Clarity Circles', description: 'Small, moderated spaces for honest progress, shared prompts, and gentle accountability.', action: 'Coming soon', href: '#circles', status: 'Coming soon', tone: 'muted' },
